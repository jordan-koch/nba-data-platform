...
| [data-engineer-agent](data-engineer-agent/) | planned | **Tooling, not pipeline** — the feature *is* a subagent that owns implementation work, with its own definition and an editable memory file. Would be the repo's first write-capable subagent. |
